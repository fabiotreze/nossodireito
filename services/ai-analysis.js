...
const ANALYSIS_JSON_SCHEMA = {
  ...
  schema: {
    ...
    properties: {
      ...
      direitos_sugeridos: {
        ...
        items: {
          ...
          properties: {
            ...
            justificativa: { type: "string", description: "Trecho LITERAL do texto (máx 120 caracteres) que motivou a menção desta categoria. Não opinar, não interpretar." },
            confianca: { type: "string", enum: ["alta", "media", "baixa"] },
          },
        },
      },
      resumo: {
        type: "string",
        description: "Resumo FACTUAL e NEUTRO em pt-BR (máx 200 palavras) descrevendo apenas o que o texto contém: CIDs identificados, datas, condições. PROIBIDO: recomendar, orientar, sugerir ação, prometer resultado, opinar sobre direito ou tratamento.",
      },
      confianca: {
        type: "string",
...
const SYSTEM_PROMPT = [
  ...
  "3. NUNCA orienté ação do usuário: PROIBIDO usar verbos como 'procure', 'agende', 'solicite', 'recorra', 'peça', 'faça', 'denuncie', 'você pode', 'você tem direito', 'você deve'.",
  "4. NUNCA prometa resultado: PROIBIDO 'você terá', 'você conseguirá', 'você receberá', 'isso garante'.",
  "5. Para cada CID identificado, liste apenas categorias do catálogo cuja base legal cobre aquele CID. Em 'justificativa', cole o TRECHO LITERAL do texto (máx 120 caracteres) que motivou a menção. Não resuma, não interprete — copie.",
  "6. Confiança 'alta' apenas quando CID aparece textualmente + contexto inequívoco. Caso contrário, 'media' ou 'baixa'.",
  "7. Resumo deve ser FACTUAL e NEUTRO: descreva o que o documento contém, não o que o usuário deve fazer. Ex: 'Documento cita CID F84.0 e data 12/03/2025' (✅) vs 'Você pode solicitar BPC' (❌ proibido).",
