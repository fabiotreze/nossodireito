...
Este documento lista **todos os problemas conhecidos, limitações técnicas e workarounds** do projeto NossoDireito. Serve como **base de conhecimento** para usuários, desenvolvedores e colaboradores.
...
**Problema:**  
O plugin oficial VLibras (https://vlibras.gov.br) não funciona em navegadores mobile devido a limitações do módulo do Governo Federal.

**Impacto:**  
- ⚠️ Funcionalidade de Libras **INDISPONÍVEL** em dispositivos móveis
- ✅ Todas as outras funcionalidades (TTS, contraste, fonte) funcionam normalmente

**Solução:**  
- **Desktop:** Use Firefox, Chrome ou Edge (100% funcional)
- **Mobile:** Instale o app [Hand Talk](https://handtalk.me/br/aplicativo/) (gratuito)
- **Alternativa:** Use botão "🔊 Ouvir" (TTS) — funciona em todos dispositivos

**Status:**  
🟡 **Erro conhecido do Gov.br** — Sem previsão de correção

**Detalhes:**  
Ver [docs/VLIBRAS_LIMITATIONS.md](VLIBRAS_LIMITATIONS.md)
...
- 🔜 v2.0.0: Code splitting por categoria
...
**Roadmap:**  
- 🔜 v2.0.0: Filtros por estado (dropdown na busca)
- 🔜 v2.0.0: Geolocalização automática (pedir permissão GPS)

**Status:**  
🟡 **Planejado** — v2.0.0 (jun 2026)
...
**Futuro:**  
- ⚠️ v2.0.0: Se adicionar 50+ benefícios, pode ultrapassar 10 MB
