# 🔒 NossoDireito — Auditoria de Segurança v1.14.7
...
**Novidades v1.14.7**: 30 categorias de direitos PcD, IPVA/SEFAZ/DETRAN para 27 estados inline, Servidor Node.js 22 LTS com HSTS + rate limiting + CSP server-side, integração VLibras (Libras) via CSP allowlist, Web Speech API (TTS nativa), hospedagem Azure App Service com SSL via Key Vault.
...
*Documento atualizado em 2026-02-28 como parte do processo de Security Review do NossoDireito v1.14.7.*
